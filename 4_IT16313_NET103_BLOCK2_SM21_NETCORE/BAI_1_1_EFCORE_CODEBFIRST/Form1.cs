...
namespace BAI_1_1_EFCORE_CODEFIRST
{
    public partial class Form1 : Form
    {
        ...
        void LoadGridAccount()
        {
            ...
            {
                drgrid_Acc.Rows.Add(x.Acc,x.Sex==1?"Nam":"Nữ",x.Status== true?"Hoạt động":"Không hoạt động",_serviceQl.GetlstRoles().Where(c=>c.Id== x.Role.Id).Select(c=>c.Name).FirstOrDefault());
            }
        }
        ...
        private void btn_ThemAcc_Click(object sender, EventArgs e)
        {
            Account acc = new Account
            {
                ...
                Role = _serviceQl.GetlstRoles().Where(c=>c.Name == cbx_LoaiTK.Text).FirstOrDefault(),
            };
        ...
        private void btn_SuaAcc_Click(object sender, EventArgs e)
        {
            ...
            acc.Role = _serviceQl.GetlstRoles().Where(c => c.Name == cbx_LoaiTK.Text).FirstOrDefault();
        ...
        private void drgrid_Acc_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbx_LoaiTK.Text = _serviceQl.GetlstRoles().Where(c => c.Id == acc.Role.Id).Select(c => c.Name)
                .FirstOrDefault();
        }
